...
<div style="position: relative; text-align: center; padding: 40px 20px; z-index: 1;">
  <h1 style="color: white; margin-top: -80px;">Hey there, I'm <span style="color:#8e2de2;">Divyansh Patel 👋</span></h1>
  <h3 style="color: white;">🚀 Full-Stack Developer | 🧠 Web 3.0 Enthusiast | 🦄 NFT & DeFi Believer</h3>
